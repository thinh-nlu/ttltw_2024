    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <ul class="nav nav-tabs pl-lg-5">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="revenueYear.jsp">Doanh thu tháng theo năm</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="revenueMonth.jsp">Doanh thu ngày theo tháng</a>
                </li>
            </ul>
            <div>
        ...
        <script>
            ...
            function updateChart() {
                ...
                fetch('../MonthlyRevenue?year=' + year)
                    .then(response => response.json())
                    .then(data => {
                        yValues = xValues.map(month => data[month] || 0);
                        ...
                        myChart = new Chart(document.getElementById('myChart'), {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    data: yValues,
                                    backgroundColor: ["#80AF81","#80AF81","#80AF81","#80AF81","#80AF81","#80AF81","#80AF81","#80AF81","#80AF81","#80AF81","#80AF81","#80AF81"]
                                }]
                            },
                            options: {
                                ...
                                title: {
                                    display: true,
                                    text: "Thống kê doanh thu các tháng trong năm " + year
                                }
                            }
                        });
                    })
